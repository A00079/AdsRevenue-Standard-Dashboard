                    ...
                    <Toolbar>
                        ...
                        <div className="flex flex-col ml-4">
                            <Typography className={classes.title} variant="h6" noWrap>
                                <span className="font-semibold text-indigo-800">AdsRevenue</span>
                            </Typography>
                            ...
                            open ? <div className="lg:w-full md:full w-full">
                                <div className="h-full flex flex-row justify-between items-center rounded-lg">
                                    ...
                                    <div className="flex-grow">
                                        <div className="flex flex-row justify-between items-center">
                                            <h2 className="text-blue-800 title-font font-bold">Holden Caulfield</h2>
                                            <img src="/img/checkmark.png" className="ml-1 object-contain object-cover w-4 h-4" />
                                        </div>
                ...
                <List>
                    <div onClick={() => activePanel('manageemployees')} className={activePanelNumber == '1' ? 'border-blue-700 border-l-4 rounded-r-full bg-indigo-100' : 'hover:border-blue-700 border-l-4 rounded-r-full hover:bg-indigo-100'}>
                        <ListItem button onClick={handleEmployees}>
                            ...
                            <ListItemText><span className="text-sm text-purple-800 font-bold">Manage Employees</span></ListItemText>
                    ...
                    <div onClick={() => activePanel('shootemails')} className={activePanelNumber == '2' ? 'border-blue-700 border-l-4 rounded-r-full bg-indigo-100' : 'hover:border-blue-700 border-l-4 rounded-r-full hover:bg-indigo-100'}>
                        <ListItem button onClick={handleShootemails}>
                            ...
                            <ListItemText><span className="text-sm text-purple-800 font-bold">Shoot Emails</span></ListItemText>
                    ...
                    <Collapse in={openshootemails} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItem button className={classes.nested}>
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs">Single Email</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs">Bluck Emails</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs">External File</span></ListItemText>
                            </ListItem>
                        </List>
                    </Collapse>
                    <div onClick={() => activePanel('emailtemplates')} className={activePanelNumber == '3' ? 'border-blue-700 border-l-4 rounded-r-full bg-indigo-100' : 'hover:border-blue-700 border-l-4 rounded-r-full hover:bg-indigo-100'}>
                        <ListItem button onClick={handleEmailTemplates}>
                            ...
                            <ListItemText><span className="text-sm text-purple-800 font-bold">Email Templates</span></ListItemText>
                    ...
                    <Collapse in={openemailtemplates} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItem button className={classes.nested}>
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Business Services</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded ">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Marketing</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded ">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Events</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded ">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Newsletter</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded ">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Service Promotion</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded ">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Product Promotion</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded ">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Welcome</span></ListItemText>
                            </ListItem>
                            <ListItem button className={classes.nested}>
                                <ListItemIcon>
                                    <div className="bg-indigo-100 p-0 rounded ">
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Thankyou</span></ListItemText>
                            </ListItem>
                        </List>
                    </Collapse>
                    <div onClick={() => activePanel('shootmessages')} className={activePanelNumber == '4' ? 'pointer-events-none border-blue-700 border-l-4 rounded-r-full bg-indigo-100' : 'pointer-events-none hover:border-blue-700 border-l-4 rounded-r-full hover:bg-indigo-100'}>
                        <ListItem button onClick={handleShootMessages}>
                            ...
                            <ListItemText><span className="text-sm text-purple-800 font-bold">Shoot Messages</span></ListItemText>
                    ...
                    <Collapse in={openshootmessages} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItem button className={classes.nested}>
                                ...
                                <ListItemText><span className="text-green-700 font-bold text-xs break-words">Bulk Messages</span></ListItemText>
                            </ListItem>
                        </List>
                    </Collapse>
